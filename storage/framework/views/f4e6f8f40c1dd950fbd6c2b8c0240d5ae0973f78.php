...
<?php $__env->startSection('content'); ?>
    <div class="container vh-100 py-5">
        <div class="col-md-6 p-4 shadow-sm rounded">
            ...
            <hr>
            <form action="<?php echo e(route('destination.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                        value="<?php echo e(old('category')); ?>" required autocomplete="category" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Jobs\dolanesia\resources\views/destination/create.blade.php ENDPATH**/ ?>